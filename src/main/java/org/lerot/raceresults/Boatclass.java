...
public class Boatclass
{
    ...
    public Boatclass(String akey, String alongname, String acypher)
    {
        setKey(akey);
    ...
    public int compareTo(Boatclass otherclub)
    {
        if (fullName == null)
        {
            return +0;
    ...
    public String toXML()
    {
        return "<boatclass  key=\"" + this.key + "\" fullname=\"" + this.fullName + "\" cypher=\"" + this.cypher + "\" /> \n";
    }
